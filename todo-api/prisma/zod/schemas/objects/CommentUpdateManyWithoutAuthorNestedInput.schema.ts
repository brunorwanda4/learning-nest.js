...
const Schema: z.ZodType<Prisma.CommentUpdateManyWithoutAuthorNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => CommentUpdateManyWithWhereWithoutAuthorInputObjectSchema),
        z
          .lazy(() => CommentUpdateManyWithWhereWithoutAuthorInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const CommentUpdateManyWithoutAuthorNestedInputObjectSchema = Schema;
