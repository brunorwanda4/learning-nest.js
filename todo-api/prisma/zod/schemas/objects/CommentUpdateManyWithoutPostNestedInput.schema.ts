...
const Schema: z.ZodType<Prisma.CommentUpdateManyWithoutPostNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => CommentUpsertWithWhereUniqueWithoutPostInputObjectSchema),
        z
          .lazy(() => CommentUpsertWithWhereUniqueWithoutPostInputObjectSchema)
          .array(),
      ])
      .optional(),
    createMany: z
    ...
    update: z
      .union([
        z.lazy(() => CommentUpdateWithWhereUniqueWithoutPostInputObjectSchema),
        z
          .lazy(() => CommentUpdateWithWhereUniqueWithoutPostInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const CommentUpdateManyWithoutPostNestedInputObjectSchema = Schema;
